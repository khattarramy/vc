...
public class OrderDetailResource {
    ...
    public List<OrderDetail> getOrderDetails(@QueryParam("retailerId") int retailerId, @QueryParam("distributorId") int distributorId, @QueryParam("manufacturerId") int manufacturerId, @QueryParam("status") String status) throws UnknownHostException {
